...
class ArduinobotTask_Goal(metaclass=Metaclass_ArduinobotTask_Goal):
    ...
    _fields_and_field_types = {
        'task_number': 'int32',
        'arm_goal': 'sequence<double>',
        'gripper_goal': 'sequence<double>',
    }
    ...
    def __init__(self, **kwargs):
        ...
        self.arm_goal = array.array('d', kwargs.get('arm_goal', []))
        self.gripper_goal = array.array('d', kwargs.get('gripper_goal', []))
    ...
    def __eq__(self, other):
        ...
        if self.task_number != other.task_number:
            return False
        if self.arm_goal != other.arm_goal:
            return False
    ...
    @builtins.property
    def arm_goal(self):
        """Message field 'arm_goal'."""
        return self._arm_goal

    @arm_goal.setter
    def arm_goal(self, value):
        if self._check_fields:
            if isinstance(value, array.array):
                assert value.typecode == 'd', \
                    "The 'arm_goal' array.array() must have the type code of 'd'"
                self._arm_goal = value
                return
            ...
            assert \
                ...
                "The 'arm_goal' field must be a set or sequence and each value of type 'float' and each double in [-.000000, .000000]"
        self._arm_goal = array.array('d', value)
    ...
    def gripper_goal(self, value):
        if self._check_fields:
            if isinstance(value, array.array):
                assert value.typecode == 'd', \
                    "The 'gripper_goal' array.array() must have the type code of 'd'"
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 all(isinstance(v, float) for v in value) and
                 all(not (val < -1.7976931348623157e+308 or val > 1.7976931348623157e+308) or math.isinf(val) for val in value)), \
                "The 'gripper_goal' field must be a set or sequence and each value of type 'float' and each double in [-.000000, .000000]"
        self._gripper_goal = array.array('d', value)
