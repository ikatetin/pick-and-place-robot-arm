...
size_t size_function__ArduinobotTask_Goal__arm_goal(const void * untyped_member)
{
  const auto * member = reinterpret_cast<const std::vector<double> *>(untyped_member);
  return member->size();
}

const void * get_const_function__ArduinobotTask_Goal__arm_goal(const void * untyped_member, size_t index)
{
  const auto & member =
...
void * get_function__ArduinobotTask_Goal__arm_goal(void * untyped_member, size_t index)
{
  auto & member =
...
void fetch_function__ArduinobotTask_Goal__arm_goal(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const double *>(
    get_const_function__ArduinobotTask_Goal__arm_goal(untyped_member, index));
  auto & value = *reinterpret_cast<double *>(untyped_value);
  value = item;
}

void assign_function__ArduinobotTask_Goal__arm_goal(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<double *>(
    get_function__ArduinobotTask_Goal__arm_goal(untyped_member, index));
  const auto & value = *reinterpret_cast<const double *>(untyped_value);
  item = value;
}

void resize_function__ArduinobotTask_Goal__arm_goal(void * untyped_member, size_t size)
{
  auto * member =
    reinterpret_cast<std::vector<double> *>(untyped_member);
  member->resize(size);
...
size_t size_function__ArduinobotTask_Goal__gripper_goal(const void * untyped_member)
{
  const auto * member = reinterpret_cast<const std::vector<double> *>(untyped_member);
  return member->size();
}

const void * get_const_function__ArduinobotTask_Goal__gripper_goal(const void * untyped_member, size_t index)
{
  const auto & member =
    *reinterpret_cast<const std::vector<double> *>(untyped_member);
  return &member[index];
...
void * get_function__ArduinobotTask_Goal__gripper_goal(void * untyped_member, size_t index)
{
  auto & member =
    *reinterpret_cast<std::vector<double> *>(untyped_member);
  return &member[index];
...
void fetch_function__ArduinobotTask_Goal__gripper_goal(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const double *>(
    get_const_function__ArduinobotTask_Goal__gripper_goal(untyped_member, index));
  auto & value = *reinterpret_cast<double *>(untyped_value);
  value = item;
}

void assign_function__ArduinobotTask_Goal__gripper_goal(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<double *>(
    get_function__ArduinobotTask_Goal__gripper_goal(untyped_member, index));
  const auto & value = *reinterpret_cast<const double *>(untyped_value);
  item = value;
}

void resize_function__ArduinobotTask_Goal__gripper_goal(void * untyped_member, size_t size)
{
  auto * member =
    reinterpret_cast<std::vector<double> *>(untyped_member);
  member->resize(size);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember ArduinobotTask_Goal_message_member_array[3] = {
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(arduinobot_msgs::action::ArduinobotTask_Goal, arm_goal),  // bytes offset in struct
    nullptr,  // default value
    size_function__ArduinobotTask_Goal__arm_goal,  // size() function pointer
    get_const_function__ArduinobotTask_Goal__arm_goal,  // get_const(index) function pointer
    get_function__ArduinobotTask_Goal__arm_goal,  // get(index) function pointer
    fetch_function__ArduinobotTask_Goal__arm_goal,  // fetch(index, &value) function pointer
    assign_function__ArduinobotTask_Goal__arm_goal,  // assign(index, value) function pointer
    resize_function__ArduinobotTask_Goal__arm_goal  // resize(index) function pointer
  },
  {
    "gripper_goal",  // name
    ::rosidl_typesupport_introspection_cpp::ROS_TYPE_DOUBLE,  // type
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(arduinobot_msgs::action::ArduinobotTask_Goal, gripper_goal),  // bytes offset in struct
    nullptr,  // default value
    size_function__ArduinobotTask_Goal__gripper_goal,  // size() function pointer
    get_const_function__ArduinobotTask_Goal__gripper_goal,  // get_const(index) function pointer
    get_function__ArduinobotTask_Goal__gripper_goal,  // get(index) function pointer
    fetch_function__ArduinobotTask_Goal__gripper_goal,  // fetch(index, &value) function pointer
    assign_function__ArduinobotTask_Goal__gripper_goal,  // assign(index, value) function pointer
    resize_function__ArduinobotTask_Goal__gripper_goal  // resize(index) function pointer
  }
};
