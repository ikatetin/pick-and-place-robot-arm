...
#include "rosidl_runtime_c/primitives_sequence.h"  // arm_goal, gripper_goal
#include "rosidl_runtime_c/primitives_sequence_functions.h"  // arm_goal, gripper_goal
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: arm_goal
  {
    size_t size = ros_message->arm_goal.size;
    auto array_ptr = ros_message->arm_goal.data;
  ...
  {
    size_t size = ros_message->gripper_goal.size;
    auto array_ptr = ros_message->gripper_goal.data;
    cdr << static_cast<uint32_t>(size);
    cdr.serialize_array(array_ptr, size);
  }
  ...
  arduinobot_msgs__action__ArduinobotTask_Goal * ros_message)
{
  ...
  // Field name: arm_goal
  {
    ...
    if (ros_message->arm_goal.data) {
      rosidl_runtime_c__double__Sequence__fini(&ros_message->arm_goal);
    }
    if (!rosidl_runtime_c__double__Sequence__init(&ros_message->arm_goal, size)) {
      fprintf(stderr, "failed to create array for field 'arm_goal'");
      return false;
    }
    auto array_ptr = ros_message->arm_goal.data;
  ...
  // Field name: gripper_goal
  {
    ...
    if (ros_message->gripper_goal.data) {
      rosidl_runtime_c__double__Sequence__fini(&ros_message->gripper_goal);
    }
    if (!rosidl_runtime_c__double__Sequence__init(&ros_message->gripper_goal, size)) {
      fprintf(stderr, "failed to create array for field 'gripper_goal'");
      return false;
    }
    auto array_ptr = ros_message->gripper_goal.data;
    cdr.deserialize_array(array_ptr, size);
